...
//         g_game.edasteroid = this.game.add.button(64, this.game.height - 32, 'asteroid', function() {
...
// var object = game.add.sprite(game.input.activePointer.x,game.input.activePointer.y,'asteroid');
